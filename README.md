...
(Author: Frank Trollman; Editor: Lokathor; In addition to small punctuation adjustments and spelling fixes, this version makes some terminology and organizational changes from the original while attempting to not actually change the mechanics in any significant way; Original Posting: [The Gaming Den](http://tgdmb.com/viewtopic.php?t=52316))
